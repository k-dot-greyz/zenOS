...
### 2. With Dex System
**Location:** `/workspace/dex/`

**Flow:**
```text
Research on procedures/models → Extract patterns → Update dex YAML files
```
...
**Files to update:**
- `dex/procedures.yaml` - Workflow procedures
- `dex/models.yaml` - AI model configurations
