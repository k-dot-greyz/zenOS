...
├── workflows/           # Automation scripts and processes
├── automation/          # GitHub Actions, n8n flows
└── README.md           # This file
```
...
*Part of the zenOS ecosystem - where AI meets personal sovereignty* ✨
