...
**Decision**: Adopt three documentation tiers — active (`docs/`, `README.md`, `dex/`), archive (`docs/archive/`), and ADRs (`DECISION_LOG.md`) — documented in `docs/guides/DOCUMENTATION_GUIDE.md`, with ecosystem repo relationships in `repos/registry.yaml`.  
