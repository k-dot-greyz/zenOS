...
from tts_queue_system import MessagePriority, TTSConfig, TTSQueueManager
...
class StreamerBotIntegration:
    ...
    def process_follow(self, follower_name: str):
        ...
        return self.tts_manager.add_message(
            ...
            priority=MessagePriority.HIGH,
            metadata={"type": "follow", "follower": follower_name},
...
class WebSocketServer:
    ...
    def __init__(
        self, streamer_bot: StreamerBotIntegration, host: str = "localhost", port: int = 8765
    ):
...
async def main():
    ...
    try:
        ...
        # Mod command
        streamer_bot.process_chat_message(
            "Moderator", "!tts Welcome everyone to the stream!", is_mod=True
        )
