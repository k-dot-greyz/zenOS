...
if command -v n8n &> /dev/null; then
    ...
    echo ""
    echo "   # Or using Docker (persistent volume and env for external modules):"
    echo "   docker run -it --name n8n \\"
    echo "     -p 5678:5678 \\"
    echo "     -e NODE_FUNCTION_ALLOW_EXTERNAL=js-yaml \\"
    echo "     -e NODE_FUNCTION_EXTERNAL_MODULES=/home/node/.n8n/node_modules \\"
...
echo "     # Example (with persistent volume):"
echo "     docker run -it --name n8n \\"
echo "       -p 5678:5678 \\"
echo "       -e NODE_FUNCTION_ALLOW_EXTERNAL=js-yaml \\"
echo "       -e NODE_FUNCTION_EXTERNAL_MODULES=/home/node/.n8n/node_modules \\"
...
echo "   - Restart n8n after configuration (ensure the env vars are applied at process start)"
echo ""
