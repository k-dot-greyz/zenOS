                ...
                for genesis_file in genesis_files:
                    ...
                    if file_path.exists():
                        try:
                            ...
                            console.print(f"[yellow]Warning: Could not load {genesis_file}: {e}[/yellow]")
    ...
    def format_context_for_prompt(self) -> str:
        ...
        if self.project_context:
            ...
            if 'is_zenos' in self.project_context:
                parts.append(f"Working on zenOS v{self.project_context.get('zenos_version', 'unknown')}")
