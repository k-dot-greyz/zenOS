...
class SafeCommandExecutor:
    ...
    def run_command(self, cmd: Union[List[str], str], cwd: Optional[Union[str, Path]] = None, 
    ...
    def safe_pip_install_requirements(self, requirements_file: str = "requirements.txt") -> Dict:
        ...
        return self.run_command([sys.executable, '-m', 'pip', 'install', '-r', requirements_file], timeout=180)
...
def safe_git_workflow(message: str, details: Optional[List[str]] = None, 
                     push: bool = True, remote: str = "origin", branch: str = "main") -> Dict:
