...
def setup(config: Optional[str]):
    ...
    console.print("2. Extract conversations: [green]zen pkm extract[/green]")
    console.print("3. Process knowledge: [green]zen pkm process[/green]")
    console.print("4. Search conversations: [green]zen pkm search 'your query'[/green]")
